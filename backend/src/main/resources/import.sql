...
insert into roteador (nome, descricao, preco, id_sinalWireless, id_sistemaOperacional, id_bandaFrequencia, id_protocoloSeguranca, id_quantidadeAntena) values ('Roteador de Firewall Cisco RV110W-A-NA-K9 RV110W Wireless N VPN', 'Firewall Cisco rv110w wireless n vpn', 899.90, 1, 1, 1, 7, 2);
...
insert into roteador (nome, descricao, preco, id_sinalWireless, id_sistemaOperacional, id_bandaFrequencia, id_protocoloSeguranca, id_quantidadeAntena) values ('TP-Link Sistema Wi-Fi Deco X60 AX3000', 'Sistema Wi-Fi de malha residencial TP-Link Deco X60 WiFi 6 AX3000, pacote com 3', 2820.00, 1, 2, 2, 1, 1);
