...
export class FuncionarioService {
  ...
  findByNome(nome?: string, page?: number, pageSize?: number): Observable<IPaginator<Funcionario>> {
    let params = {};
    ...
    return this.httpClient.get<IPaginator<Funcionario>>(`${this.baseUrl}/search/nome/${nome}`, { params });
  }
